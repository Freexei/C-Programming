...
main()
{
    ...
    int x;      // variable deceleration to stores first integer when user is prompted at line 11
    int y;      // variable to stores 2nd integer when user is prompted at line 13
